const base = {
    ...
    insertContentCategory:"/api/content/insertContentCategory", // 广告导航管理 添加
    updateContentCategory:"/api/content/updateContentCategory", // 广告导航管理 修改导航
    deleteContentCategoryById:"/api/content/deleteContentCategoryById", // 广告导航管理 删除
